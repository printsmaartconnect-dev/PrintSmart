      ...
      <main className="mx-auto max-w-[1600px] px-4 py-6 sm:px-6 lg:px-8 animate-fade-in">
        ...
        <div className="flex items-center gap-3">
          <Link
            ...
            className="inline-flex items-center justify-center w-9 h-9 rounded-lg border border-gray-200 bg-white text-gray-800 hover:bg-slate-50 transition-all active:scale-95 flex-shrink-0"
